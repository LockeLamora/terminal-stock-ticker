...
module DisplayOutput
  ...
  def generate_table(portfolio)
    ...
    portfolio.symbol_shortlist.each do |symbol|
      ...
      portfolio.symbols[symbol].price_delta_normalised > 0 ? content = content.to_s.green : content = content.to_s.red
      row << content
      ...
      row.push portfolio.symbols[symbol].average_owned_price_normalised.to_s
